...
class CorporationsControllerTest < ActionController::TestCase
  ...
  test "should create corporation" do
    assert_difference('Corporation.count') do
      post :create, corporation: { address: @corporation.address, avatar: @corporation.avatar, industry: @corporation.industry, name: @corporation.name, phone_number: @corporation.phone_number, web_site: @corporation.web_site }
    end
  ...
  test "should update corporation" do
    patch :update, id: @corporation, corporation: { address: @corporation.address, avatar: @corporation.avatar, industry: @corporation.industry, name: @corporation.name, phone_number: @corporation.phone_number, web_site: @corporation.web_site }
    assert_redirected_to corporation_path(assigns(:corporation))
  end
